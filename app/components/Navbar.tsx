  ...
  return (
    ...
    >
      <div className='relative'>
        ...
        <div className={`sm:max-w-3xl md:max-w-4xl w-[80vw] h-14 my-10 rounded-lg bg-white dark:bg-black bg-opacity-40 dark:bg-opacity-40 grid ${isDesktop ? 'grid-cols-3' : 'grid-cols-2'} justify-between items-center`}>
          <div>
            <Link href="/">
              <Image
                src='/avatar.jpg'
